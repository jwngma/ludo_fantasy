  ...
  void generateTxnToken(int mode, ProgressDialog progressDialog) async {
    ...
    try {
      ...
      var paytmResponse = Paytm.payWithPaytm(
          mid, orderId, txnToken, widget.amount.toString(), callBackUrl, testing);
      progressDialog.hide();
          ...
          if (value['error']) {
            ...
            if (value['response'] != null) {
              ...
              if (value['response']['RESPCODE'] == "01" &&
                ...
                progressDialog.show();
                _fireStoreServices
                    .addTransactions(context, "${value['response']['TXNID']}",
                    widget.amount)
                    .then((valu) {
                  progressDialog.hide();
                  Navigator.of(context).push(MaterialPageRoute(builder: (_) {
                    return SuccesfulPurchase(
                      ...
                      desc: "You have Successfully Participated",
