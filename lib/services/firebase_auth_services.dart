...
//
//    print("Auth Facebook Login Result :${facebookLoginResult.errorMessage}");
//
//    if (facebookLoginResult != null) {
//      print("Login With Facebook is not null");
//
//     // FacebookAccessToken myToken = facebookLoginResult.accessToken;
//    //  print("FacebookAccessToken :${myToken}");
//
//      final token = facebookLoginResult.accessToken.token;
//      print("FacebookAccessToken 2:${token}");
//      AuthCredential credential =
//          FacebookAuthProvider.getCredential(accessToken: token);
//      print("Auth Credential :${credential.toString()}");
//
//      FirebaseUser user =
