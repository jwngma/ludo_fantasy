...
class Constants {
  ...
  static const String app_name = "Ludo Fantasy";
  static const String desc_about_app =
  '''Ludo Fantasy is a fun app for Playing Ludo Match .We have developed this application to let the users toparticipate in a ludo match in a fun way. We are planning to add more fun games and events in near future''';
...
//Image
  ...
  static const String app_logo = "ludo_fantasy_logo.png";
  static const String nodata_icon="assets/images/no_data_icon.png";

  static const String ludo_banner_image="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSAu5MJk7EsfOeTZmmNc9b9zpVPnHb0LZOSjA&usqp=CAU";
  ...
  ''' Ludo Fantasy is Ultimate Solution to all your Favorite eSports Games.''';
  static const String descText2 =
  ''' Ludo Fantasy is an Online Portal which Offers Unlimited Entertainement and Rewards for your ability to perform in the event. 
      Currently it Supports Pubg Mobile Tournament, 
      and are hoping to add all the trending games like Mobile Legends, Clah Royale, Free Fire and many More''';
  static const String descText3 =
  '''Founded and lauched on 16-05-2020, was developed by one of the android developer and Pubg lover, as a Source of Earning for the Pubg Players''';
  static const String descText4 =
  '''You might be addicted to playing games in your mobiles, but just think what if you can start earning money by playing you favorite or addicted mobile games. Well this is what we  Ludo Fantasy Offers''';
  static const String welcome_desc =
      "Are you addicted to Online Games? Have you ever thought of earning through Online Gaming or from Playing Mobile Games? What if you were "
      "rewarded for playing your favorite games and that too of which you are addicted to? Well, PlayerZon is the Platform which makes this possible.";

  static const String share_link =
      "Download the  Ludo Fantasy App, particpate in  Ludo Tournaments. "
      "We can earn Money by playing the tournament, "
      "for Winning the matches, as Much as You can."
      " Link- https://ludomatch.blogspot.com/";
  ...
  static const String terms_condition =
      ...
      "We will never charge you for the app or its services without making it very clear to you exactly what you’re paying for. The Ludo Fantasy app"
      ...
      "programs, compromise your phone’s security features and it could mean that the Ludo Fantasy app won’t work properly or at all. The"
  ...
  static const String privacy =
      "The Developer of the App built the  Ludo Fantasy app as a Commercial app. This SERVICE is provided by Jwngma basumatary  and his team and "
      ...
      "our Terms and Conditions, which is accessible at  Ludo Fantasy unless otherwise defined in this Privacy Policy.";
