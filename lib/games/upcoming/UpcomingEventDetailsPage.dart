...
import 'package:ludofantasy/screens/faq_screen.dart';
import 'package:ludofantasy/screens/home_page.dart';
import 'package:ludofantasy/screens/profile_page.dart';
...
import 'package:ludofantasy/wallet/PaymentScreen.dart';
    ...
    if (!userparticipated) {
      if (name == "" || name == null||ludoName == "" || ludoName == null) {
        ...
        showDialog(
            ...
            builder: (context) => CustomDialogWithOk(
                  title: "Name is Empty",
                  description: " Please Update Your Username & Pubg Name",
                  primaryButtonText: "Ok",
                  primaryButtonRoute: ProfilePage.routeName,
                ));
      } else if (amount < widget.eventModel.entryFee) {
        progressDialog.hide();
        showDialog(
            context: context,
            builder: (context) => CustomDialogWithOk(
                  ...
                  primaryButtonText: "OK",
                  primaryButtonRoute: PaymentScreen.routeName,
                ));
      } else if (amount >= widget.eventModel.entryFee) {
        print("can Proccedd");
